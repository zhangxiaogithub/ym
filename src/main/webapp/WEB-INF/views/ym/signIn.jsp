...
<body>
	...
	<form:form id="inputForm" modelAttribute="signIn" action="${ctx}/signIn/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="count" htmlEscape="false" maxlength="50" class="required input-small"/>&nbsp;&nbsp;份
			</div>
		</div>
		...
		<div class="control-group">
			<label class="control-label">（选填）每天限制：</label>
			<div class="controls">
				<form:input path="num" htmlEscape="false" maxlength="50" class="required input-small"/>&nbsp;&nbsp;羊毛币
			</div>
		</div>
